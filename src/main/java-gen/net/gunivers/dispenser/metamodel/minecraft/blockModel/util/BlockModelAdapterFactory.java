/**
 */
package net.gunivers.dispenser.metamodel.minecraft.blockModel.util;

import java.util.Map;

import net.gunivers.dispenser.metamodel.minecraft.blockModel.*;
 ...
 * <!-- end-user-doc -->
 * @see net.gunivers.dispenser.metamodel.minecraft.blockModel.BlockModelPackage
 * @generated
 */
public class BlockModelAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.BlockModel <em>Block Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.BlockModelDisplayPlace <em>Display Place</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.BlockModelElement <em>Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.BlockModelElementRotation <em>Element Rotation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.BlockModelElementFace <em>Element Face</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
