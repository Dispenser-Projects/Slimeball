 ...
 * </p>
 * <ul>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementRotationImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementRotationImpl#getAngle <em>Angle</em>}</li>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementRotationImpl#getRescale <em>Rescale</em>}</li>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementRotationImpl#getAxis <em>Axis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockModelElementRotationImpl extends MinimalEObjectImpl.Container implements BlockModelElementRotation {
	 ...
	 * @ordered
	 */
	protected static final Boolean RESCALE_EDEFAULT = Boolean.FALSE;
