 ...
 * </p>
 * <ul>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementImpl#getFrom <em>From</em>}</li>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementImpl#getTo <em>To</em>}</li>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementImpl#getShade <em>Shade</em>}</li>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementImpl#getRotation <em>Rotation</em>}</li>
 *   <li>{@link net.gunivers.dispenser.metamodel.minecraft.blockModel.impl.BlockModelElementImpl#getFaces <em>Faces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockModelElementImpl extends MinimalEObjectImpl.Container implements BlockModelElement {
	 ...
	 * @ordered
	 */
	protected static final Boolean SHADE_EDEFAULT = Boolean.TRUE;
