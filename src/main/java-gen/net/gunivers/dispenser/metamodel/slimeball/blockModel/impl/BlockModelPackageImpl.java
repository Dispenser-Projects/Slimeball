...
import net.gunivers.dispenser.metamodel.slimeball.blockModel.BlockModelFactory;
...
import net.gunivers.dispenser.metamodel.slimeball.blockModel.DisplayPosition;
...
public class BlockModelPackageImpl extends EPackageImpl implements BlockModelPackage {
	 ...
	 * @generated
	 */
	private EClass blockModelTexturesEClass = null;
	 ...
	 * @see net.gunivers.dispenser.metamodel.slimeball.blockModel.BlockModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getBlockModel_Parent() {
		return (EReference)blockModelEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getBlockModelTextures() {
		return blockModelTexturesEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getBlockModelTextures_Particle() {
		return (EAttribute)blockModelTexturesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getBlockModelTextures_Variables() {
		return (EReference)blockModelTexturesEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(blockModelEClass, BLOCK_MODEL__PARENT);
		createEAttribute(blockModelEClass, BLOCK_MODEL__AMBIENT_OCCLUSION);
		...
		blockModelTexturesEClass = createEClass(BLOCK_MODEL_TEXTURES);
		createEAttribute(blockModelTexturesEClass, BLOCK_MODEL_TEXTURES__PARTICLE);
		createEReference(blockModelTexturesEClass, BLOCK_MODEL_TEXTURES__VARIABLES);
		...
		createEAttribute(blockModelElementFaceEClass, BLOCK_MODEL_ELEMENT_FACE__TINT_INDEX);
	...
	public void initializePackageContents() {
		...
		initEReference(getBlockModel_Parent(), this.getBlockModel(), null, "parent", null, 0, 1, BlockModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBlockModel_AmbientOcclusion(), theEcorePackage.getEBooleanObject(), "ambientOcclusion", null, 0, 1, BlockModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlockModel_Textures(), this.getBlockModelTextures(), null, "textures", null, 0, 1, BlockModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(blockModelTexturesEClass, BlockModelTextures.class, "BlockModelTextures", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBlockModelTextures_Particle(), theEcorePackage.getEString(), "particle", null, 0, 1, BlockModelTextures.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBlockModelTextures_Variables(), this.getKeyValuePair(), null, "variables", null, 0, -1, BlockModelTextures.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBlockModelElement_Shade(), theEcorePackage.getEBooleanObject(), "shade", null, 0, 1, BlockModelElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBlockModelElementRotation_Rescale(), theEcorePackage.getEBooleanObject(), "rescale", null, 0, 1, BlockModelElementRotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBlockModelElementFace_Rotation(), theEcorePackage.getEIntegerObject(), "rotation", null, 0, 1, BlockModelElementFace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBlockModelElementFace_TintIndex(), theEcorePackage.getEIntegerObject(), "tintIndex", null, 0, 1, BlockModelElementFace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
